...
export default function HomePage() {
  return (
    <main className="font-body">
      <Horizon>
        <Header />
        <div className="mx-auto max-w-6xl px-6 pt-40 pb-28 sm:pt-52 sm:pb-36">
          <p className="eyebrow text-cloud/80 mb-5">
            Een initiatief van Apotheek Numansdorp
          </p>
          <h1 className="font-display text-4xl sm:text-6xl leading-[1.08] text-cloud max-w-3xl">
            Elke ochtend zonder sigaret begint bij één beslissing.
          </h1>
          <p className="mt-6 max-w-xl text-cloud/90 text-lg leading-relaxed">
